...
#Region "Windows Form Designer generated code "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		Me.lblDescription.Caption = "A demonstration that you can build better MDI apps using forms' properties and methods"
		...
		Me.lblDisclaimer.Caption = "Warning:   feel free to reuse this code in your own application, as well as change it to meet your needs"
