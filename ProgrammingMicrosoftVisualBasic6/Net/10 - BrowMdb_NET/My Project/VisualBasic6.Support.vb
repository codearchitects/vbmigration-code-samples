...
#Region "Default instances"
	...
	Private m_DAO_DBEngine_DefInstance As DAO.DBEngine

	Public ReadOnly Property DAO_DBEngine_DefInstance() As DAO.DBEngine
		Get
			If m_DAO_DBEngine_DefInstance Is Nothing Then m_DAO_DBEngine_DefInstance = New DAO.DBEngine()
		Return m_DAO_DBEngine_DefInstance
		End Get
	End Property
...
#Region "Resources support"
   ...
   Public Function LoadResString6(ByVal id As Integer) As String
      Return DirectCast(GetResourceFromID("str", id), String)
   End Function

   Public Function LoadResPicture6(ByVal id As Integer, ByVal resType As Integer) As Object
      Dim prefix As String = Microsoft.VisualBasic.Choose(resType + 1, "bmp", "ico", "cur")
      Return GetResourceFromID(prefix, id)
   End Function

   Public Function LoadResData6(ByVal id As Integer, ByVal resType As Object) As Object
   ...
   Private Function GetResourceFromID(ByVal prefix As String, ByVal id As Integer) As Object
      Dim res As Object = resourceMan.GetObject(prefix & id.ToString(), Nothing)
      ...
      Else
         ...
         res = resourceMan.GetObject(prefix.ToUpper() & id.ToString(), Nothing)
      End If
      ' Check whether the resource is missing or is of the wrong type
      If res Is Nothing Then Err.Raise(326, , "Resource with identifier '" & id.ToString() & "' not found")
      Return res
   End Function
