...
Private Sub cmdStart_Click()
    ...
    Log.LogEvent "Creating the X object", vbLogEventTypeInformation
    
    Set x = CreateObject("MThrApp.CCountDown")
    x.Counter = Val(txtSeconds)
    
    Log.LogEvent "Setting X to Nothing", vbLogEventTypeInformation
    
    Set x = Nothing
    Beep
    
    Log.LogEvent "Exiting the cmdStart_Click() procedure"
End Sub
