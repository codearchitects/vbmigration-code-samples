...
If rs_sec.RecordCount < 1 Then MsgBox "No section in the list.Please check it!", vbExclamation, "CSRS version 1": Exit Sub
If Not ListView1.SelectedItem = "" And Not rs_sec.RecordCount < 1 Then rs_sec.AbsolutePosition = ListView1.SelectedItem
...
With rs_sec
    ...
    '---------------------------------
    If .RecordCount < 1 Then MsgBox "No section in the list.Please check it!", vbExclamation, "CSRS version 1": Exit Sub
    '---------------------------------
    ...
    If ans = vbYes Then
        ...
        Call delete_rec(cn, "tblSections", "SectionNo", "", True, Val(ListView1.SelectedItem.ListSubItems(1)))
        .Requery
